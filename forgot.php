                ...
                <form action="#" method="post">
                    ...
                    <div class="pmd-card-body paddingrl wow fadeIn">
                        ...
                        <div class="form-group pmd-textfield">
                            ...
                            <div class="input-group ">
                                <div class="input-group-addon"><i class="material-icons md-light pmd-sm">mail_outline</i></div>
                                <input class="form-control" type="email" id="email" name="email" required>
                            </div>
                        </div>
                    </div>
                    <div class="pmd-card-footer card-footer-no-border card-footer-p16 text-center wow fadeInUp">
